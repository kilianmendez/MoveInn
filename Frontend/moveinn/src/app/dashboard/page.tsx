        ...
        <div className="flex">
            ...
            <div className="container mx-auto px-4 py-6">
                ...
                <div className="space-y-8">
                    ...
                    <Card className="border-none shadow-sm">
                    <CardHeader>
                        <CardTitle className="text-xl text-[#0E1E40]">Your Erasmus Journey</CardTitle>
                    ...
                    <CardContent>
                        ...
                        <div className="pt-2">
                            ...
                            <div className="flex flex-col items-center">
                                <div className="w-12 h-12 rounded-full bg-[#B7F8C8]/20 flex items-center justify-center mb-1">
                                <GlobeIcon className="h-6 w-6 text-[#4C69DD]" />
                                </div>
                                <span className="text-xs text-center">Explorer</span>
                            </div>
                            <div className="flex flex-col items-center">
                                <div className="w-12 h-12 rounded-full bg-[#B7F8C8]/20 flex items-center justify-center mb-1">
                                <Users2Icon className="h-6 w-6 text-[#4C69DD]" />
                                </div>
                                <span className="text-xs text-center">Socializer</span>
                            </div>
                            <div className="flex flex-col items-center">
                                <div className="w-12 h-12 rounded-full bg-[#B7F8C8]/20 flex items-center justify-center mb-1">
                                <TrendingUpIcon className="h-6 w-6 text-[#4C69DD]" />
                                </div>
                                <span className="text-xs text-center">Learner</span>
                            </div>
                            </div>
                        </div>

                        <div className="pt-2">
                            <p className="text-sm font-medium mb-2">Next Goals</p>
                            <ul className="space-y-2">
                            <li className="flex items-center text-sm">
                                <div className="w-5 h-5 rounded-full border border-[#4C69DD] flex items-center justify-center mr-2">
                                <div className="w-2 h-2 rounded-full bg-[#4C69DD]"></div>
                                </div>
                                Attend 3 more cultural events
                            </li>
                            <li className="flex items-center text-sm">
                                <div className="w-5 h-5 rounded-full border border-[#4C69DD] flex items-center justify-center mr-2">
                                <div className="w-2 h-2 rounded-full bg-[#4C69DD]"></div>
                                </div>
                                Complete language exchange program
                            </li>
                            <li className="flex items-center text-sm">
                                <div className="w-5 h-5 rounded-full border border-[#4C69DD] flex items-center justify-center mr-2">
                                <div className="w-2 h-2 rounded-full bg-[#4C69DD]"></div>
                                </div>
                                Visit 2 more cities in Spain
                            </li>
                            </ul>
                        </div>
                        </div>

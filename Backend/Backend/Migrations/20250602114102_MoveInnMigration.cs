...
{
    /// <inheritdoc />
    public partial class MoveInnMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ErasmusCountry = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ErasmusDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumsThread", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ForumsThread_Forum_ForumId",
                        column: x => x.ForumId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcommodationType = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HostSince = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumsMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ForumsMessages_ForumsMessages_ParentMessageId",
                        column: x => x.ParentMessageId,
                        principalTable: "ForumsMessages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ForumsMessages_ForumsThread_ThreadId",
                        column: x => x.ThreadId,
                        principalTable: "ForumsThread",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageAccommodations", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "HostsSpeciality",
                columns: table => new
                {
                    HostsId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    SpecialtiesId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HostsSpeciality", x => new { x.HostsId, x.SpecialtiesId });
                    table.ForeignKey(
                        name: "FK_HostsSpeciality_Hosts_HostsId",
                        column: x => x.HostsId,
                        principalTable: "Hosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HostsSpeciality_Speciality_SpecialtiesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UserId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    RecommendationId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Images", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Images_Recommendations_RecommendationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumsMessages_ParentMessageId",
                table: "ForumsMessages",
                column: "ParentMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_ForumsMessages_ThreadId",
                table: "ForumsMessages",
                column: "ThreadId");

            migrationBuilder.CreateIndex(
                name: "IX_ForumsThread_ForumId",
                table: "ForumsThread",
                column: "ForumId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HostsSpeciality_SpecialtiesId",
                table: "HostsSpeciality",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_RecommendationId",
                table: "Images",
